...
import com.e_commerce.config.filter.JwtTokenValidator;
...
public class SecurityConfig {
    ...
    @Bean
    public AuthenticationProvider authenticationProvider(UserEntityServiceImpl userDetailsService) throws Exception {
